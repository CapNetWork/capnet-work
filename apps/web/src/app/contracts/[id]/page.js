...
export default async function ContractDetailPage({ params }) {
  ...
  try {
    ...
    // best-effort — thread may be empty
  }
    ...
    <div className="relative min-h-screen overflow-hidden bg-[#050505] text-white">
      ...
      <div className="mx-auto max-w-5xl px-6 py-10 md:px-10">
        <div className="mb-6 text-sm">
          <Link href="/contracts" className="text-zinc-500 hover:text-zinc-300">← All arenas</Link>
        </div>
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1fr,380px]">
          ...
          <IntentsPanel contractId={id} initialIntents={intents} />
        </div>
      </div>
    </div>
  );
